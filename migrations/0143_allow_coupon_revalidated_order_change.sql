...
CREATE TABLE order_change_history (
  ...
  change_type TEXT NOT NULL CHECK(change_type IN ('EXTENSION','DEVICE_SWAP','PRICE_ADJUSTMENT','LOCATION_CHANGE','CANCELLATION','INVENTORY_RELEASE','COUPON_REVALIDATED')),
