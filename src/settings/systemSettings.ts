...
export const systemSettings = {
  ...
  feedbackRewards: {
    ...
    couponDiscountValueMin: 5,
    couponDiscountValueMax: 5,
...
<p>本用户协议（下称「本协议」）是您与 {company_name}（ABN {company_abn}）之间就使用本网站及相关设备租赁服务达成的约定。注册账户、提交租赁申请或以其他方式使用本网站，即表示您已阅读、理解并同意本协议。</p>
<p><strong>版本：</strong>{user_terms_version}　<strong>最后更新：</strong>{user_terms_last_updated_date}</p>
<h2>一、适用范围</h2><p>本协议适用于所有访问或使用本网站的用户。本协议与<a href="/service-terms">《服务条款》</a>、<a href="/privacy">《隐私政策》</a>、<a href="/acceptable-use">《可接受使用政策》</a>及具体订单对应的<a href="/rental-agreement">《设备租赁协议》</a>一并构成完整约定；如相互冲突，以针对具体事项更具体的文件为准。</p>
<h2>二、账户注册与类型</h2>
<ul>
<li>下单过程中可创建<strong>访客账户</strong>，用于完成单次租赁；访客账户可能在租期结束后失效。</li>
<li>设置密码后可升级为<strong>正式账户</strong>，长期保留订单与合同记录。</li>
<li>您需年满 18 周岁并具备完全民事行为能力方可注册和签署合同。</li>
</ul>
<h2>三、账户安全与资料真实性</h2><p>您应提供真实、准确、完整的注册与身份核验资料，并在信息变化时及时更新。您须妥善保管账户凭据，对通过您账户进行的操作负责；发现未经授权使用的，应立即通知我们。</p>
<h2>四、服务使用规范</h2><p>您不得利用本网站或租赁设备从事违法活动、干扰平台运行、绕过安全措施、冒用他人身份或侵犯他人合法权益。设备使用的详细限制见<a href="/acceptable-use">《可接受使用政策》</a>。</p>
<h2>五、下单、合同与付款</h2><p>提交租赁申请不构成合同成立；租赁关系以双方签署的《设备租赁协议》及订单确认为准。费用、押金、逾期费与损坏赔偿以下单页面和合同载明为准，退款处理见<a href="/refund-policy">《退款政策》</a>。</p>
<h2>六、知识产权</h2><p>本网站的文字、界面、标识及软件的知识产权归 {company_name} 或相应权利人所有。未经书面许可，您不得复制、传播、改编或用于商业目的。</p>
<h2>七、服务变更与中断</h2><p>我们可基于运营、安全或法律要求调整、暂停或终止部分功能，并会在适当位置公布重要变化。因维护、故障或不可抗力导致的服务中断，我们在合理范围内尽力恢复。</p>
<h2>八、账户暂停与终止</h2><p>如您严重或反复违反本协议或相关政策，我们可暂停或终止您的账户，并保留追偿损失的权利。您也可以随时联系我们注销账户；法律要求或为处理未了结的订单、款项与争议所需的记录将按《隐私政策》保留。</p>
<h2>九、责任限制与消费者保障</h2><p>在法律允许的最大范围内，我们不对间接、偶发或后果性损失承担责任。本协议不排除、不限制您在《澳大利亚消费者法》下不可排除的权利，详见<a href="/consumer-rights">《澳大利亚消费者法下的权利》</a>。</p>
<h2>十、个人信息处理</h2><p>我们按<a href="/privacy">《隐私政策》</a>和<a href="/cookies">《Cookie 政策》</a>收集和使用您的个人信息。使用本服务即表示您已知悉相关处理方式。</p>
<h2>十一、投诉与争议解决</h2><p>如对服务有异议，请先按<a href="/complaints">《投诉与争议解决政策》</a>与我们联系。本协议受维多利亚州法律管辖。</p>
<h2>十二、协议更新</h2><p>更新后的协议将在本页面公布并注明版本与更新日期。重大变更会通过网站通知或邮件提示；更新生效后继续使用服务即表示接受更新后的内容。</p>
<h2>十三、联系我们</h2><p>{company_name}<br>地址：{company_address}<br>电话：{company_phone}<br>邮箱：{company_email}</p>`,
