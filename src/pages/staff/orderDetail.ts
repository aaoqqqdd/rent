    ...
    <div class="panel order-detail-shell staff-order-detail">
      ...
      <div class="order-detail-grid">
        ...
        <div class="order-info-card order-actions-card">
          ...
          ` : ''}
          ${['paid', 'pending_pickup'].includes(String(order.status)) ? `<button class="button button-primary" type="button" id="open-handover-dialog">记录交付并开始租赁</button>` : ''}
