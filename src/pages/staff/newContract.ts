    ...
    <div class="panel">
      <form action="/staff/contracts/create" method="post">
        ...
        <div class="grid grid-2" style="margin-top: 16px;">
          ...
          <div class="form-group"><label for="coupon-code" class="form-label">优惠码（选填）</label><input type="text" id="coupon-code" name="couponCode" class="form-control" maxlength="40" placeholder="输入优惠码"></div>
        </div>
