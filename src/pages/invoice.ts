...
export async function renderInvoice(c: Context, user: any, orderId: string, printMode = false) {
  ...
  // Print via a hidden iframe loading the chrome-free /invoice/print route, so the
  // button behaves like the contract's print button (print dialog opens in place,
