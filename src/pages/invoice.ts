...
export async function renderInvoice(c: Context, user: any, orderId: string, printMode = false) {
  ...
  const controls = printPageFix + '<div class="contract-actions" style="margin-bottom:20px"><button class="button button-primary" type="button" onclick="window.print()">打印 / 下载 PDF</button></div>'
